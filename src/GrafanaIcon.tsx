export function GrafanaIcon() {
    return <svg x="0px" y="0px"
        width="16" height="16" viewBox="0 0 351 365"
    >
        <linearGradient id="GRAFANA_ICON_SVGID_1_" gradientUnits="userSpaceOnUse" x1="175.5" y1="30%" x2="175.5" y2="99%">
            <stop offset="0" style={{ stopColor: "#F05A28" }} />
            <stop offset="1" style={{ stopColor: "#FBCA0A" }} />
        </linearGradient>
        <path fill="url(#GRAFANA_ICON_SVGID_1_)" d="M342,161.2c-0.6-6.1-1.6-13.1-3.6-20.9c-2-7.7-5-16.2-9.4-25c-4.4-8.8-10.1-17.9-17.5-26.8
